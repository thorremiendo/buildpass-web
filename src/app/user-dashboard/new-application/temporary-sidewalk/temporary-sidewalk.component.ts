...
@Component({
  selector: 'app-temporary-sidewalk',
  templateUrl: './temporary-sidewalk.component.html',
  styleUrls: ['./temporary-sidewalk.component.scss'],
})
export class TemporarySidewalkComponent implements OnInit {
