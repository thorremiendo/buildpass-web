...
export class AdminUsersViewComponent implements OnInit {
    ...
    approveUser() {
      ...
      this._adminUserService.approveEmployee(this.userInfo.id).subscribe(result =>
        {
      ...
      this._userService
        ...
        .subscribe(data => {
          ...
          this._barangayService.getBarangayInfo().subscribe(data => {
            this._barangay = data;
            this._filteredBarangayOptions = this.adminUpdateUserFormControl.barangay.valueChanges
            .pipe(
              startWith(''),
