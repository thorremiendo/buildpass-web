...
@NgModule({
  declarations: [EvaluatorHomeComponent, NewTasksComponent, OpenedTasksComponent, ClosedTasksComponent, TableViewComponent, CalendarViewComponent, ApplicationDetailsComponent],
  imports: [
    CommonModule,
